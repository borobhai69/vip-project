...
BLEService ledService("114829FF-CDBE-4B02-AC91-F77CDC6E3C55"); // BLE LED Service

// BLE LED Switch Characteristic - custom 128-bit UUID, read and writable by central
BLEByteCharacteristic switchCharacteristic("114829FF-CDBE-4B02-AC91-F77CDC6E3C55", BLERead | BLEWrite);
